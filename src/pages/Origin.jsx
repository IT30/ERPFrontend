...
export class Origin extends Component {
  ...
  changeOriginDescription = (e) => {
    this.setState({ OriginDescription: e.target.value });
  };
  ...
  editClick(org) {
    this.setState({
      ...
      IDOrigin: org.idOrigin,
      OriginName: org.originName,
      OriginDescription: org.originDescription,
    });
  }
  ...
  deleteClick(id) {
    if (window.confirm("Are you sure?")) {
      fetch(variables.API_URL + "origin/" + id, {
        method: "DELETE",
        headers: {
          Accept: "application/json",
          Authorization: "Bearer " + localStorage.getItem("token"),
  ...
  render() {
    const { origins, modalTitle, IDOrigin, OriginName, OriginDescription } =
      this.state;
        ...
        <table className="table table-striped">
          ...
          <tbody>
            {origins.map((org) => (
              <tr key={org.idOrigin}>
                <td>{org.idOrigin}</td>
                <td>{org.originName}</td>
                <td>{org.originDescription}</td>
                <td>
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    className="btn btn-light mr-1"
                    onClick={() => this.deleteClick(org.idOrigin)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="input-group mb-3">
                  <span className="input-group-text">Origin name</span>
                  <input
                    type="text"
